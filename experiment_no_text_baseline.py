...
# Ensure text columns are dropped and not used in any way
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", type=Path, default=Path("no_text_baseline_submission.csv"))
