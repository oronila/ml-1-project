"""LightGBM with much deeper trees, smaller leaves, more regularization. Diversity for ensemble."""
...
def main():
    ...
    ap.add_argument("--out", default="lgbm_v2_submission.csv")
    ...
    for fold, (tr_idx, va_idx) in enumerate(skf.split(X_train, y), 1):
        ...
        b = lgb.train(params, ds_t, num_boost_round=4000, valid_sets=[ds_v],
