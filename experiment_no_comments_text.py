...
def add_text_features(out, df):
    # ONLY use REMARKS, NOT COMMENTS as per new constraint.
...
def build_model():
    return HistGradientBoostingClassifier(
        max_iter=1000, learning_rate=0.02, max_leaf_nodes=255, l2_regularization=0.2,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", type=Path, default=Path("no_comments_text_submission.csv"))
