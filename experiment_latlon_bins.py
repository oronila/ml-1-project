...
DAMAGE_WORDS = ["damage", "damaged", "engine", "wing", "windshield", "radome", "nose", "ingest", "blood", "dent", "hole", "crack"]
...
def build_model():
    return HistGradientBoostingClassifier(
        max_iter=650, learning_rate=0.04, max_leaf_nodes=63, l2_regularization=0.05,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", type=Path, default=Path("experiment_geo_bins_submission.csv"))
